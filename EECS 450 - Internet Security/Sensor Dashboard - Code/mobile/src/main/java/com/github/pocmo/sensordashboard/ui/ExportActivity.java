...
//        mRealm.close();
    ...
    private void exportFile() {
        ...
        try {
            ...
            int begin = 0;
            int total_valid_row = total_row;
            if(result.get(total_row - 1).getDatatype() == 1){
                total_valid_row = total_row - 1;
            }else if(result.get(total_row - 1).getDatatype() == 4){
                total_valid_row = total_row - 2;
            }
            while(true){
                if(result.get(begin).getDatatype() == 1 && result.get(begin + 1).getDatatype() == 4 && result.get(begin + 2).getDatatype() == 9){
                    break;
                }else{
                    begin++;
                }
            ...
            for (int i = begin; i < total_valid_row; i++) {
//                if(i == 1 && result.get(total_row - 1).getDatatype() == 9){
//                    continue;
//                }else if(i == 1 && result.get(total_row - 1).getDatatype() == 4){
//                    continue;
//                }
